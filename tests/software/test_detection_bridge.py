...
def create_test_session(base_dir="detects"):
    ...
    image_dir = os.path.join(base_dir, "{}_to_detect_images".format(session_ts))
    log_path = os.path.join(base_dir, "{}_detected.log".format(session_ts))
    output_dir = os.path.join(base_dir, "{}_detected".format(session_ts))
